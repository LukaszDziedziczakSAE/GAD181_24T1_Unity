...
public class DangerTargetShooting_Target : MonoBehaviour
{
    ...
    public static event Action<DangerTargetShooting_Target> OnTargetPoppedUp;
    DangerTargetShooting_TargetController controller;
    ...
    private void Awake()
    {
        controller = GetComponentInParent<DangerTargetShooting_TargetController>();
    }
    private void Update()
    {
